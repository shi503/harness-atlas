...
| 2026-09-07 | `2026-09-07-dx-scorecard` | Seven DX dimensions are added as an authored headline layer over the ten axes, never computed. DX-5 Ecosystem is admitted as the one graded dimension | [`spectrums/01-scorecard.md` §1](spectrums/01-scorecard.md#1-requirements--three-rules-on-top-of-r1r7) | PERMANENT |
