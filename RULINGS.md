...
| 2026-09-08 | `2026-09-08-deep-read-claims` | The deep read's **highlighted gate is retired** for a per-commission depth negotiation; the set carries the vendor's claim ledger, and its guide maps claim → mechanism. **That mapping records, it does not grade** | [`RULING-2026-09-08-deep-read-claims.md`](RULING-2026-09-08-deep-read-claims.md#3-the-claim-test-records-it-does-not-grade) | PERMANENT |
| 2026-09-08 | `2026-09-08-authorship-provenance` | **R11's `verification:` block extends from the scorecard to every authored analysis** — profiles, deep-read documents, positions. The backfill of files whose model was never captured is an **attestation** and says so in `note:`; going forward `drafted_by` is captured at write time | [`RULING-2026-09-08-authorship-provenance.md`](RULING-2026-09-08-authorship-provenance.md#3-the-backfill-is-an-attestation-and-the-files-say-so) | PERMANENT |
