...
> **Prior art, genericized.** This is a first-party framework written for a specific engineering
> organization in April 2026, carried into this repository as the direct ancestor of the Grid. It is
...
> where a justification was a specific incident, the incident is described in kind rather than in
> particular. That is the intended trade.

> **Version:** 0.2 — Hybrid restructure: merged external maturity model with first-party grounding **Status:** 🟡 In Progress — pending team calibration **Author:** KD (Product Manager) **Date:** 2026-04-07 **Audience:** Feature team \+ exec leadership **Inspired by:** Nielsen Norman Group UX Maturity Model, McKinsey State of AI, Microsoft WorkLab Frontier Firm, BCG AI Workforce Strategy, industry AI maturity frameworks **Companion doc:** `L1-08-ai-native-team-operations-research.md` (named company examples, tool tradeoffs, 7-component rubric)

---

## Why This Document Exists

The organization is trying to launch a production SaaS platform on a compressed timeline with a small team. The org spans multiple levels of AI adoption maturity — from individuals who haven't committed to working with AI, to a product team actively building with AI-native toolchains. This spread creates friction: mismatched expectations about velocity, quality, and how work gets done.
...
3. **Provides concrete workflows** showing what high-performing AI-native teams actually do, grounded in both general principles and the organization's own toolchain
...
**Org signal:** Parts of the org are here. Some individuals use AI tools; it's not expected or standardized.
...
**Org signal:** The product/dev team (two people) is attempting to operate here — using Claude Code, FRACTAL orchestration, agent-based development, and a dedicated planning surface. But the broader org's processes (decision cadence, resource allocation, review cycles) are still Stage 1-2, creating the friction documented in D-112.
...
**Org example:** The current feature team (three people) operating with Claude Code \+ FRACTAL orchestration is closer to the AI-native model than a traditional 7-person team — but is constrained by org-level processes designed for the traditional model (D-112).
...
**"This will reduce headcount"** AI-native doesn't mean fewer people. It means the same people produce 5-10x more output. The launch timeline (Jul 7\) is only possible with AI-native velocity. With traditional agile, it would be a Q4 2026 or Q1 2027 deliverable.
...
**The feature team (current assessment):**

| \# | Component | Score | Evidence |
| :---- | :---- | :---- | :---- |
| 1 | Team Composition | 🟡 | 3 humans, blurring roles, some agent use |
...
| Analyst capacity constraint forces timeline extension | AI-native development reduces dependency on individual capacity |
...
5. **Pilot Stage 5 processes** on the feature team as proof-of-concept  
...
- The initiative framework (`00-Initiative-Framework.md`)  
- The discovery log (`01-Discovery-Log.md`) — D-112 organizational readiness risk  
