...
| **Codex CLI** | OpenAI | Reads `AGENTS.md` + skills. Supported by gstack `--host`, SageOx, Gas City FWP | `[V]` |
...
inclusion test above breaks — is [`../04-harness-alignment.md`](../04-harness-alignment.md).
