...
4. **`thoughts/CLAUDE.md` is auto-generated.** The context layer writes the harness's instruction
   ...
   [`../02-component-matrix.md`](../02-component-matrix.md) — the row added 2026-08-27 whose emptiness
...
bracket the session.** [`../02-component-matrix.md`](../02-component-matrix.md) should treat the
