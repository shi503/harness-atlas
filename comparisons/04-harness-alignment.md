...
row in a teardown under [`systems/harnesses/`](../harnesses), and every row there carries a URL,
...
| **Teardown** | [`systems/harnesses/hermes.md`](../harnesses/hermes.md) | [`systems/harnesses/pi.md`](../harnesses/pi.md) | [`systems/harnesses/openclaw.md`](../harnesses/openclaw.md) | [`systems/harnesses/opencode.md`](../harnesses/opencode.md) | [`systems/harnesses/grok.md`](../harnesses/grok.md) |
...
| | Component | v1 horizon | Hermes | Pi | OpenClaw | OpenCode | Grok | What the row shows |
|---|---|---|---|---|---|---|---|---|
...
OpenCode 10 / 13 / 10 · Grok 19 / 10 / 4. The totals are not a ranking — the next section is about
...
(2026-08-24, [`systems/harnesses/hermes.md`](../harnesses/hermes.md) §G, ◐): *"An approval waits
...
by a consultant who runs it for clients ([`systems/harnesses/hermes.md`](../harnesses/hermes.md)
...
[`systems/harnesses/`](../harnesses) — the four teardowns, every cell sourced ·
