...
[`../elements.md`](../archive/elements.md) §1 says the metaphor does real work in exactly one document; this
...
| **Covered?** | ❌ **Not covered — and this document's own notation depends on it.** [`02-component-matrix.md`](./02-component-matrix.md) marks `●` as *"owns it as a named primitive"* across 18 components and 9 systems, and the term was never defined |
...
*Next: [`02-component-matrix.md`](./02-component-matrix.md) — the same systems, by component.*
