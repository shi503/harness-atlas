...
than through design ([`03-jtbd.md`](../archive/comparisons/03-jtbd.md) §2 `J16`).
...
graded one layer down at [`4a`](./4a-capability.md), where the question is whether a
...
**What this layer is not.** It is not [`9a`](./9a-learning.md) Learning. `F8` decomposed on
...
[`3e`](./3e-standards.md) Standards, which is the artifact the convention lands *in*;
