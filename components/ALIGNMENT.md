...
owner: KD
provenance: DERIVED
extends: archive/spec/v1-framework/00-README.md
---
...
**Why now.** [`00-README.md`](../archive/comparisons/00-README.md) §3 declined to tear down harnesses because *"the harness
...
**Notation.** As [`02-component-matrix.md`](./MATRIX.md) §1: `●` owns it as a **named
primitive** — [`01-concepts.md`](../archive/comparisons/01-concepts.md) §3.17, *a minimal, named, composable unit that the
...
[`00-README.md`](../archive/comparisons/00-README.md) §1.4 asks three questions and says a system needs all three to be a
...
Read with [`02-component-matrix.md`](./MATRIX.md): that grid is process layers across
...
external corroboration the split has. It also confirms pattern #10 in [`00-README.md`](../archive/comparisons/00-README.md)
...
[`02-component-matrix.md`](./MATRIX.md) §1: *"The count is small everywhere — five to seven
...
types travel as one unit. That is pattern #3 in [`00-README.md`](../archive/comparisons/00-README.md) §5, *thin harness, fat
...
standards list in [`00-README.md`](../archive/comparisons/00-README.md) §2 and from
[`2026-08-research/05-standards-layer.md`](../archive/comparisons/2026-08-research/05-standards-layer.md); it should be added
...
`F-4` in [`00-README.md`](../archive/comparisons/00-README.md) narrowed the headline claim to the **join** between what an
...
[`02-harness-taxonomies.md`](../archive/comparisons/2026-08-research/02-harness-taxonomies.md) §3 finding — cost accounting
...
[`00-README.md`](../archive/comparisons/00-README.md) §1.2 found *harness* naming two layers — QM is *"a harness"* that runs
...
- **No change to the inclusion test or the category name.** §1.1, §1.2 and §4.1 record where the test
  and the adapter tell break, and propose a third altitude; [`01-concepts.md`](../archive/comparisons/01-concepts.md) decides.
- **Four columns were added to [`02-component-matrix.md`](./MATRIX.md)**, beside Claude
...
*Companion: [`00-README.md`](../archive/comparisons/00-README.md) — the category argument this file tests ·
[`02-component-matrix.md`](./MATRIX.md) — the process-layer grid on the other axis ·
