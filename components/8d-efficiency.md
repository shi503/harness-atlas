...
[`9f`](./9f-diagnose-the-bottleneck.md) states its own dependency on this job explicitly. An
...
**What this layer is not.** It is not [`8c`](./8c-observability.md) — the same event stream
