...
([`../archive/v0/05-preflight-spec.md`](../../v0/05-preflight-spec.md), marked ❌ *rebuild*) treated
...
([`../archive/v0/05-preflight-spec.md`](../../v0/05-preflight-spec.md) §3). What is new is that the
...
**Where it comes from.** [`03-maturity.md`](../../v0/03-maturity.md) §3's third threshold —
...
**Where it comes from.** [`03-maturity.md`](../../v0/03-maturity.md) §1: *"if your AI-native stage
...
*Back to [`00-README.md`](./00-README.md) · the derivation in [`CROSSWALK.md`](./CROSSWALK.md) · the ancestor at [`../archive/v0/05-preflight-spec.md`](../../v0/05-preflight-spec.md)*
