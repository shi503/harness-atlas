...
[`../archive/v0/02-functions.md`](../../v0/02-functions.md) — the ancestor is **re-argued**, per the corpus rule
...
> [`../archive/v0/02-functions.md`](../../v0/02-functions.md) carries `F0`–`F16` in its §1 map, *"in five bands"* at
...
[`../archive/v0/02-functions.md`](../../v0/02-functions.md) §0.5 forbids a fourth. **No row in §2 reads "renamed."**
...
2026-08-27** in [`../archive/v0/02-functions.md`](../../v0/02-functions.md) §6, which the scorecard was never updated
...
| The **nine-band** numbering ①–⑨ | the twelve layers | `OPEN-18`. Superseded by KD's twelve-layer note, [`../archive/v0/11-architecture.md`](../../v0/11-architecture.md) §1 |
