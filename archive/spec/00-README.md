...
|---|---|---|
| `CROSSWALK.md` §3 | [`../../components/CROSSWALK.md`](../../components/CROSSWALK.md) | Six ruling **texts**, and §3.13's candidates register — `RULINGS.md` names it as a sanctioned home for a ruling |
