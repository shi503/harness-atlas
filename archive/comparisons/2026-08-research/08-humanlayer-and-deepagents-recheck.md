...
| 2 | *"Context **provenance** … is still unclaimed by everyone in this corpus"* | [`../00-README.md`](../00-README.md) §F-4 · [`../02-component-matrix.md`](../../../components/MATRIX.md) §3 | **Partly falsified.** `deepagents/openwiki/.claims/` ships content hashing, version pinning and reconstruction over 515 claims. See §2 — the surviving claim is real and much narrower |
...
| 5 | The `Context adapter` matrix row is empty and *"its emptiness is the finding"* | [`../02-component-matrix.md`](../../../components/MATRIX.md) §1 | HumanLayer's `thoughts` occupies it — separate repo, mounted in, hook-enforced, generating the harness's own `CLAUDE.md` |
...
This is the entry that matters. [`../02-component-matrix.md`](../../../components/MATRIX.md) §3 published
...
[`../00-README.md`](../00-README.md) §F-4, [`../02-component-matrix.md`](../../../components/MATRIX.md)
...
[`../02-component-matrix.md`](../../../components/MATRIX.md) §1 has nine columns. Two are missing. Scored
...
records. LoomWarp's cell in [`../02-component-matrix.md`](../../../components/MATRIX.md) is still
*"— unstated."*
