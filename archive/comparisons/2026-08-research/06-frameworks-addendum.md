...
Seven elements × six stages. From `[../../elements.md](../../elements.md)` §3. Reproduced here so this
...
| **D-2** | **Hold mechanical enforcement at column 4**, against Factory.ai's Level 3, and say why                                              | `[../../elements.md](../../elements.md)` §3 — new *"Where we differ from the market, deliberately"* note, with the adopter translation row **LoomWarp 4 ≈ Factory 3 ≈ Microsoft 300** |
...
| --------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `[../../elements.md](../../elements.md)`                                                                              | The Grid, the three rules, the self-grade, the org bridge           |
...
| `[../02-component-matrix.md](../../../components/MATRIX.md)`                                                              | Components × systems, the `●◐○` notation                            |
...
`[../../elements.md](../../elements.md)` *— the Grid ·*
