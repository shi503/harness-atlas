...
1. **Beads or Linear** — Gas City surfaces work tracking as an explicit team choice rather than a
   default. [`../../02-component-matrix.md`](../../../../components/MATRIX.md) §2 notes we have no such
...
- [`../../02-component-matrix.md`](../../../../components/MATRIX.md) §1, §2 — the primitive set and the
  forced choice
- [`../../../../specs/v0/references.md`](../../../v0/references.md) — threads `R-1`, `R-5`
