...
*Companion: [`05-context-and-the-librarian.md`](./05-context-and-the-librarian.md) — the tier that feeds this store · [`08-appendix-schemas.md`](./08-appendix-schemas.md) §3 — the entry schema · [`../../02-component-matrix.md`](../../../../components/MATRIX.md) — the row this changes*
