...
*Companion: [`01-the-composition-contract.md`](./01-the-composition-contract.md) — why these shapes exist · [`07-transfer-manifest.md`](./07-transfer-manifest.md) — which to adopt*
