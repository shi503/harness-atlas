...
*Companion: [`../../01-concepts.md`](../../01-concepts.md) — the vocabulary · [`../../02-component-matrix.md`](../../../../components/MATRIX.md) — the rubric · `loomwarp-team-system` `references/comparisons/systems/fractal.md` (private) — the upstream this iterated from · `loomwarp-team-system` `references/comparisons/systems/loomwarp.md` (private) — the successor*
