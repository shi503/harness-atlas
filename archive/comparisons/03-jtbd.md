...
> [`../../specs/v0/02-functions.md`](../v0/02-functions.md) §0.1. **IDs are unchanged**, because
...
> [`../../specs/v0/09-context-layer.md`](../v0/09-context-layer.md). **§4's open question —
...
*Companion: [`02-component-matrix.md`](../../components/MATRIX.md) — the same systems by component ·
