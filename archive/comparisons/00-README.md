...
version and moves on its own cadence. Two of the six systems here changed materially within the last quarter. Like [`../elements.md`](../elements.md), this is durable reference material.
...
| 02 | [`02-component-matrix.md`](../../components/MATRIX.md) | The same systems by component. Two rows carry the whole competitive picture |
...
| **Full teardown — harnesses** (added 2026-09-02) | [`content/`](../../content) — Hermes · Pi · OpenClaw · OpenCode · Grok Bot / Grok Build, each against all 33 v1 components · synthesis at [`04-harness-alignment.md`](../../components/ALIGNMENT.md) | Not peers — they run the loop. Read because v1's upper-layer markers need peer citations, and because two of them (OpenClaw, Hermes) **host other harnesses**, which breaks §1.3's adapter tell and §1.4's test. `04` §4.1 proposes a third altitude |
...
[`../elements.md`](../elements.md) describes **seven** functions and publishes a seven-row self-grade.
...
| **The component matrix** | Five cells are marked inferred rather than verified — [`02-component-matrix.md`](../../components/MATRIX.md) §5 | Opportunistically |
...
*Companion: [`../elements.md`](../elements.md) — the functions and the Grid ·
[`../claude-code/`](../../content/claude-code) — the harness we run on ·
[`../../specs/archive/v0/references.md`](../v0/references.md) — the sourced catalog*
