...
[`11-architecture.md`](../../archive/v0/11-architecture.md) §1, where `Configuration` — which ships in every harness on
...
| Axis | Question | Where |
|---|---|---|
| `FUNCTION` | what does it do | [`02-functions.md`](../../archive/v0/02-functions.md) §0.1 |
| `SCOPE` | for whom — `individual \| team × project \| org` | [`02-functions.md`](../../archive/v0/02-functions.md) §0.3 |
| `PROVIDER` | what performs it, against a contract | [`02-functions.md`](../../archive/v0/02-functions.md) §0.4 |
...
[`02-functions.md`](../../archive/v0/02-functions.md) §0.3 defines `individual | team × project | org` and requires
...
*The model: [`02-functions.md`](../../archive/v0/02-functions.md) · The manifesto this feeds:
