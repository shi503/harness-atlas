...
> Argument at [`../CROSSWALK.md`](../CROSSWALK.md) §3.1.

**The distinction is narrow and it is the only one that survives, so it has to be used precisely.**
[`9c`](./component-27-cadence.md) answers *what runs without being asked*. This answers *what a person
...
**What this layer is not.** It is not [`11a`](./component-33-surfaces.md) Surfaces — a channel is
**where** people meet, this is **what they are doing there**, and `J11` lands in both for that reason
([`CROSSWALK.md`](../CROSSWALK.md) §1). It is not [`9a`](./component-25-learning.md), which is what
...
| **ours** | The **HANDOFF** gate — a real ritual with a required artifact, arrived at independently by three peers, and *"three peers reached it independently"* is the strongest structural signal in the corpus after the adapter finding. ⚠️ And the exact inverse of gstack: high control, no retro. We ship a gate between tiers and no recurring practice around it | [`systems/fractal.md`](https://github.com/shi503/loomwarp-team-system/blob/master/projects/loomwarp/references/comparisons/systems/fractal.md) §*What is genuinely good about it* · [`NEXT-STEPS.md`](../../../archive/sessions/NEXT-STEPS.md) §4 `B-3` |
