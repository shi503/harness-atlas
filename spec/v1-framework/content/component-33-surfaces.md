...
needed ([`CROSSWALK.md`](../CROSSWALK.md) §1.2).
...
**What this layer is not.** It is not [`9b`](./component-26-rituals.md) Rituals — `J11` lands in both,
and the split is that a surface is **where** people meet while a ritual is **what they are there to
do.** It is not [`6c`](./component-18-estate.md) Estate, which is where the code is; a surface is where
