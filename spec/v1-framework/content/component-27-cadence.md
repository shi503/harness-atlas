...
> record something else reads is not ([`CROSSWALK.md`](../CROSSWALK.md) §3.1).
...
**And the consumer that matters is one layer along.** [`9f`](./component-30-diagnose-the-bottleneck.md)
...
**What this layer is not.** It is not [`9b`](./component-26-rituals.md) Rituals, which is the human
practice this schedule serves — the ruling that separates them is narrow and deliberate. It is not
[`2b`](./component-04-hooks.md) Hooks: a hook is a **lifecycle point the harness defines**, and cadence
