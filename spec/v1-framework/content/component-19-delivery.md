...
repo and every person, which is [`4a`](./component-11-capability.md)'s object. Nothing in `F0`–`F16`
...
nothing to attach it to ([`CROSSWALK.md`](../CROSSWALK.md) §2.2).
...
**What this layer is not.** It is not [`8a`](./component-21-evals.md) Evals — the bar the output must
clear is a judgement, and this is the road it travels once it has cleared. It is not
[`6b`](./component-17-infrastructure.md), which is the environment the change *lands in* rather than the
