...
condition [`12-horizon.md`](../12-horizon.md) §2 defines as `emerging`, and the place where a
...
| **ours** | Agent definitions exist and score `●` in our own matrix; **the assembly does not**. There is no declared stack, no protected core, and no statement of what shares a context with what | [`02-component-matrix.md`](../../../comparisons/02-component-matrix.md) §1 |
