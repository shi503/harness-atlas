...
| **ours** | `router.py` — a deterministic resolver, and one of the few things in our own column that is genuinely built. ⚠️ It resolves against a blueprint, **not against a roster**, because no roster exists — which makes it a sequencer wearing a router's name | [`systems/loomwarp.md`](https://github.com/shi503/loomwarp-team-system/blob/master/projects/loomwarp/references/comparisons/systems/loomwarp.md) §*Architecture* |
