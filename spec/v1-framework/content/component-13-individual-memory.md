...
job: "J1 · J2"
horizon: "emerging"
img: img/130-individual-memory.png
wave: W3
...
> ([`CROSSWALK.md`](../CROSSWALK.md) §0.1, §2).
>
...
> not taken here** ([`CROSSWALK.md`](../CROSSWALK.md) §3.3).
...
`SCOPE` axis and is **still unfilled** ([`12-horizon.md`](../12-horizon.md) §4.1).
...
| **ours** | `○`. The individual/team boundary is one of three concepts the component matrix records as *treated as first-class by peers and not covered by our function model at all* | [`02-component-matrix.md`](../../../comparisons/02-component-matrix.md) §1 · [`systems/loomwarp.md`](https://github.com/shi503/loomwarp-team-system/blob/master/projects/loomwarp/references/comparisons/systems/loomwarp.md) §*What the corpus changed about our claims* |
