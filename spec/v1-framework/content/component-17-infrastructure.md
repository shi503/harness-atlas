...
job: "—"
horizon: "emerging"
img: img/170-infrastructure.png
wave: W4
...
`emerging` condition [`12-horizon.md`](../12-horizon.md) §2 defines: *"peers have built the
...
ground** ([`12-horizon.md`](../12-horizon.md) §3.2).
...
[`0a`](./component-01-substrate.md) Substrate — that is what the *agent* runs on, chosen once for the
team — and it is **not** [`1a`](./component-02-environment.md) Environment, which is the declared
...
**What this layer is not.** It is not [`6d`](./component-19-delivery.md) Delivery. Standing up an
