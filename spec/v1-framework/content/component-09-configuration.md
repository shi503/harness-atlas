...
[`00-README.md`](../00-README.md)** — bound there rather than here, because a mechanism assigned in the
...
| **ours** | Agent definitions and a settings file, and **nothing on most of the other mechanisms** — no skills directory, no commands, no hooks, no rules. A configuration surface adopted at whatever its default was | [`systems/loomwarp.md`](https://github.com/shi503/loomwarp-team-system/blob/master/projects/loomwarp/references/comparisons/systems/loomwarp.md) §*Architecture* |
