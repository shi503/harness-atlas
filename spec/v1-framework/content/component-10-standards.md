...
as separate imperatives ([`component-05-enforcement.md`](./component-05-enforcement.md)).
...
observation that *"the two halves fail differently"* ([`CROSSWALK.md`](../CROSSWALK.md) §2.1).
