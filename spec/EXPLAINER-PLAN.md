...
actually answers. [`NEXT-STEPS.md`](../archive/sessions/NEXT-STEPS.md) §2 settled *where* it is authored, *what shape* it
...
[`specs/v0/02-functions.md`](../archive/v0/02-functions.md) already carries a
...
Companion to the test [`NEXT-STEPS.md`](../archive/sessions/NEXT-STEPS.md) already sets — *"anything that would have been
...
Ten sections, order and sources unchanged from [`NEXT-STEPS.md`](../archive/sessions/NEXT-STEPS.md) §2.2. **Three change.**
...
[`NEXT-STEPS.md`](../archive/sessions/NEXT-STEPS.md) §2 already sets, passed fourteen times.
...
[`specs/v0/03-maturity.md`](../archive/v0/03-maturity.md) §2. **The stage definitions do not change**; this
...
| **Band restructuring** | KD: *"some of these do get folded into some of these systems and layers."* Folding is likely, and renumbering mid-flight is the `FM-3` defect this corpus punishes in others | [`specs/v0/11-architecture.md`](../archive/v0/11-architecture.md) §6 `OPEN-18` |
...
those five were added in [`specs/v0/11-architecture.md`](../archive/v0/11-architecture.md) §5.1 as a table
of *why each is not a rename*, and never given sections in
[`specs/v0/02-functions.md`](../archive/v0/02-functions.md).
...
*Companion: [`NEXT-STEPS.md`](../archive/sessions/NEXT-STEPS.md) §2 — where the explainer is authored and the rule that
