...
**Deep read** — `content/fractal/`, a 10-document process-layer reference set at
a finer grain than §6: `install and repository layout` ·
`the four tiers` ·
`the BLUEPRINT and the workstream PRD` ·
`router.py` · `HANDOFF and PULSE` ·
`the four evaluation layers` ·
`the un-routed instance` ·
`the kernel` ·
`the consolidated guide`
...
and an authenticated owner listing does not contain it under any name — so the deep read covers `U` and
`R` only and restates no `C` figure; the `C` deltas in §6 below stand as read 2026-09-03 and are
unverifiable now (`fractal/ISSUES.md` ISSUE-024). `08-the-kernel` covers a surface added upstream
**after** the pinned commit and has no detail row here.*
...
**More.** `02-the-four-tiers.md` §1 — every frontmatter key on all four role files, and what reads `model:`
...
**More.** `01-install-and-repository-layout.md` §1 — the two-command install and its one undeclared dependency
...
**More.** `01-install-and-repository-layout.md` §2 — the three things in the repository tree that the copy step does not install
...
**Source.** ✅ same, all three
**More.** `03-blueprint-and-workstream-prd.md` §1 — every BLUEPRINT key, and which three of six the router reads
...
**Source.** ✅ same, all three
**More.** `02-the-four-tiers.md` §5 — the overlay, and the second document in the same tree that calls it speculative
...
**Source.** ✅ same, all three
**More.** `03-blueprint-and-workstream-prd.md` §1 · `07-the-un-routed-instance.md` §2 — the substitution table, one row per router command
...
**More.** `01-install-and-repository-layout.md` §2 — six skills install, seven exist, and the README names five
...
**Source.** ✅ same, all three
**More.** `03-blueprint-and-workstream-prd.md` §2–3 — the PRD’s required sections, and the name mapping nothing performs
...
**Source.** ✅ same, all three
**More.** `06-the-evaluation-layers.md` — what each of the four templates actually is, and why the reject path has no state
...
**Source.** ✅ same, all three
**More.** `05-handoff-and-pulse.md` §1 — three HANDOFF templates with three different section lists
...
**Source.** ✅ absence, direct
**More.** `20-consolidated-guide.md` §5 — the absence, with `router.py` read in full
...
**Source.** ✅ absence, direct
**More.** `20-consolidated-guide.md` §5 — the absence, and what the tree-wide grep did and did not hit
...
**More.** `06-the-evaluation-layers.md` §6 · `07-the-un-routed-instance.md` §5 — the same ledger with two different resolution mechanisms
...
**Source.** ✅ same, all three
**More.** `06-the-evaluation-layers.md` §2 — the templates, including the hand-maintained false-positive list inside the Layer 2 prompt
...
**Source.** ✅ same, all three
**More.** `02-the-four-tiers.md` §2 — what each tier is forbidden from doing, and by what
...
**Source.** ✅ same, all three
**More.** `01-install-and-repository-layout.md` §6 — platform support, and what the second platform actually ships
