...
| *"Give longer tasks dedicated environments"* | The cloud environment model — [`11`](./11-beyond-the-cli.md) §1. Note the mechanism differs from the local one: container plus egress policy, not `sandbox_mode` |
